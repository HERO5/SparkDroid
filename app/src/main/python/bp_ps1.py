...
import input_data
tf.app.flags.DEFINE_string("ps_hosts", "192.168.1.6:2222", "ps hosts")
...
'''
python bp_ps1.py --ps_hosts=192.168.1.12:2222 --worker_hosts=192.168.1.12:2223,192.168.1.12:2224 --job_name=ps --task_index=0

python bp_ps1.py --ps_hosts=192.168.1.12:2222 --worker_hosts=192.168.1.12:2223,192.168.1.12:2224 --job_name=worker --task_index=0

python bp_ps1.py --ps_hosts=192.168.1.12:2222 --worker_hosts=192.168.1.12:2223,192.168.1.12:2224 --job_name=worker --task_index=1
'''